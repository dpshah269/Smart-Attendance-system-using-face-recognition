    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='C:/Users/Intel/Downloads/Attendace_management_system-master/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:\Users\Intel\Downloads\Attendace_management_system-master\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='snow')
                cs = 'C:/Users/Intel/Downloads/Attendace_management_system-master/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:\Users\Intel\Downloads\Attendace_management_system-master\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'disha' :
            if password == 'disha269':
                ...
                cs = 'C:/Users/Intel/Downloads/Attendace_management_system-master/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
message = tk.Label(window, text="Smart Attendance System", bg="cyan", fg="black", width=50,
...
quitWindow = tk.Button(window, text="Quit", command=manually_fill  ,fg="black"  ,bg="lawn green"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
